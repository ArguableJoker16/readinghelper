...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  } else if (selectedValue === 'Edgenuity') {
    icon.setAttribute('href', '/assets/media/favicon/edgenuity.png')
    name.textContent = 'Edgenuity'
    localStorage.setItem('name', 'Edgenuity')
    localStorage.setItem('icon', '/assets/media/favicon/edgenuity.png')
  }
