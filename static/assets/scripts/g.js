document.addEventListener('DOMContentLoaded', () => {
  const appsList = [
    ...
    {
      name: 'Age Of War',
      link: 'https://www.crazygames.com/game/age-of-war',
      image: '/assets/media/icons/crazy.webp',
      categories: ['all'],
    },
    {
      name: 'Blooket (Hacked)',
      link: '/assets/scripts/blookethacked.html/',
      image: '/assets/media/icons/blooketHacked.webp',
      categories: ['all', 'hacked'],
    },
    {
      name: 'Blooket - Login (Hacked)',
      link: '/assets/scripts/test.html/',
      image: '/assets/media/icons/blooketHacked.webp',
      categories: ['all', 'hacked'],
    },
    {
      name: 'Blooket - Play (Hacked)',
      link: '/assets/scripts/blooketplayhacked.html/',
      image: '/assets/media/icons/blooketHacked.webp',
      categories: ['all', 'hacked'],
    },
        {
      name: 'Case Clicker 2',
      link: 'https://csgo.mtsl.dk',
      image: '/assets/media/icons/caseclicker2-1.webp',
      categories: ['all', 'hacked'],
    },
    {
      name: 'Amazon Luna',
